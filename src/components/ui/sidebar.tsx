...
function SidebarTrigger({
  ...
  /** Screen-reader text, so it can follow the chosen language. */
  label?: string;
}) {
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0: as a flex item this defaults to min-width:auto, which stops
        // it shrinking beside the sidebar and pushes the page sideways at
        // tablet widths.
